...
/// <summary>
/// Compares SIMD vs Scalar implementations of signature computation
/// to demonstrate the performance benefits of vectorization.
/// </summary>
...
public class SimdVsScalarBenchmarks
{
    ...
    public void Setup()
    {
        // Create a representative dataset (region size + padding)
    ...
    public ulong[,] SIMD_Implementation()
    {
        return SignatureProcessor.ComputeSignatures(_testData);
    }

    [Benchmark]
    public ulong[,] Scalar_Reference()
    {
        return ComputeSignaturesScalar(_testData);
    }
    ...
    /// </summary>
    private static ulong[,] ComputeSignaturesScalar(uint[,] source, ulong seed = SignatureProcessor.DefaultSeed)
    {
